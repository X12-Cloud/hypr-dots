            ...
            GridLayout {
                ...
                Repeater {
                    ...
                    delegate: Rectangle {
                        ...
                        // Active condition links either keyboard matching index OR a physical pointer hover state
                        ...
                        ColumnLayout {
                            ...
                            Text {
                                ...
                                text: modelData.icon
                                color: gridItem.isFocused ? "#1C1C1E" : "#E6E1E5"
                                font.pointSize: 22
                            ...
                            Text {
                                // Renders rich text formatting strings safely
                                textFormat: Text.RichText
                                text: logoutWindow.wrapMnemonic(modelData.name, modelData.hotkey)
                                color: gridItem.isFocused ? "#1C1C1E" : "#9CA3AF"
                                font.pointSize: 8
                        ...
                        MouseArea {
                            ...
                            // Mouse moves selection state seamlessly back to track key positions cleanly
